...
module.exports = async (client, member, newRole) => {
  ...
  if (client) {
    ...
    if (client) {
      ...
      const logchannel = data.Antilog
      if (!logchannel) return;

      var antilogchannel = member.guild.channels.cache.get(logchannel)
      if (!antilogchannel) return;
      antilogchannel.send({ embeds: [nopermembed] })  
    })
    }
    })
    ...
    .setColor('#36393F')
    .setTitle('<:ayo_warning:909853615592726529> | Anti-Nuke Detected')
    .setDescription(`<:ayo_user:909855548399288320> **User**: <@${executor.id}>\n<:ayo_ban:909855911386959953> **Action**: Banned\n<:ayo_reason:909855408183730206> **Reason**: Role Update: \`BAN MEMBERS\`
    `)
    .setThumbnail(member.guild.iconURL({ dynamic: true }))
    .setFooter(`Crude Anti-Nuke`)
    .setTimestamp()
    ...
    .setColor('#36393F')
    .setTitle('<:ayo_warning:909853615592726529> | Anti-Nuke Detected')
    .setDescription(`<:ayo_user:909855548399288320> **User**: <@${executor.id}>\n<:ayo_ban:909855911386959953> **Action**: Banned\n<:ayo_reason:909855408183730206> **Reason**: Role Update: \`KICK MEMBERS\`
    `)
    .setThumbnail(member.guild.iconURL({ dynamic: true }))
    .setFooter(`Crude Anti-Nuke`)
    .setTimestamp()
    ...
    .setColor('#36393F')
    .setTitle('<:ayo_warning:909853615592726529> | Anti-Nuke Detected')
    .setDescription(`<:ayo_user:909855548399288320> **User**: <@${executor.id}>\n<:ayo_ban:909855911386959953> **Action**: Banned\n<:ayo_reason:909855408183730206> **Reason**: Role Update: \`MANAGE WEBHOOKS\`
    `)
    .setThumbnail(member.guild.iconURL({ dynamic: true }))
    .setFooter(`Crude Anti-Nuke`)
    .setTimestamp()
    ...
    .setColor('#36393F')
    .setTitle('<:ayo_warning:909853615592726529> | Anti-Nuke Detected')
    .setDescription(`<:ayo_user:909855548399288320> **User**: <@${executor.id}>\n<:ayo_ban:909855911386959953> **Action**: Banned\n<:ayo_reason:909855408183730206> **Reason**: Role Update: \`MANAGE GUILD\`
    `)
    .setThumbnail(member.guild.iconURL({ dynamic: true }))
    .setFooter(`Crude Anti-Nuke`)
    .setTimestamp()
    ...
    .setColor('#36393F')
    .setTitle('<:ayo_warning:909853615592726529> | Anti-Nuke Detected')
    .setDescription(`<:ayo_user:909855548399288320> **User**: <@${executor.id}>\n<:ayo_ban:909855911386959953> **Action**: Banned\n<:ayo_reason:909855408183730206> **Reason**: Role Update: \`MANAGE ROLES\`
    `)
    .setThumbnail(member.guild.iconURL({ dynamic: true }))
    .setFooter(`Crude Anti-Nuke`)
    .setTimestamp()
    ...
    .setColor('#36393F')
    .setTitle('<:ayo_warning:909853615592726529> | Anti-Nuke Detected')
    .setDescription(`<:ayo_user:909855548399288320> **User**: <@${executor.id}>\n<:ayo_ban:909855911386959953> **Action**: Banned\n<:ayo_reason:909855408183730206> **Reason**: Role Update: \`MANAGE CHANNELS\`
    `)
    .setThumbnail(member.guild.iconURL({ dynamic: true }))
    .setFooter(`Crude Anti-Nuke`)
    .setTimestamp()
